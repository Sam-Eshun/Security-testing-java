...
This is a security testing project using Static Taint Analysis to detect XSS vulnerabilities in a PHP web application (SchoolMate/https://sourceforge.net/projects/schoolmate) using the pixy tool.
