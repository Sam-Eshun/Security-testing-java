...
$trimmedstudent=intval($_POST['student']);
 $query = mysql_query("SELECT studentid, fname, lname FROM students WHERE studentid = ".intval($_POST['student'])."")
   or die("ParentViewCourses.php: Unable to get the studentid $trimmedstudent - ".mysql_error());
