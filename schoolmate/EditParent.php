<?php
 ...
 $query = mysql_query("SELECT userid, fname, lname FROM parents WHERE parentid = ".intval($id[0])."")
...
print("  </select>
	...
	// print out the list of parents for the drop-down box //
	 $query = mysql_query("SELECT userid FROM parents WHERE parentid = ".intval($id[0])."")
...
print("     </select>
  ...
  <input type='hidden' name='parentid' value='".intval($id[0])."'>
